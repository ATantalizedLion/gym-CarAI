...
class LessSimpleCarAIEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.track_name = 'zigzag'  # has better first corner to allow easier learning
    ...
    def step(self, action, dt):
        ...
        self.reward = -0.1  # reward for current state if not at a checkpoint
        if self.manual:
